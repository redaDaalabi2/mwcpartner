            ...
            <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
              <div class="max-w-[570px] mb-12 lg:mb-0">
                ...
                <div class="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div class="w-full">
                    <h4 class="font-bold text-dark text-xl mb-1">Adresse</h4>
                    <p class="text-base text-body-color">
                      N° 245 AV BOUJDOUR SAFI MAROC 
                    </p>
                  </div>
                </div>
                <div class="flex mb-8 max-w-[370px] w-full">
                ...
                <div class="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div class="w-full">
                    ...
                    <p class="text-base text-body-color">mwcpartner@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="bg-white relative rounded-lg p-8 sm:p-12 shadow-lg">
                <form>
                  <div class="mb-6">
                    <input
                        type="text"
                        placeholder="Entrer voter nom et prenom"
                        class="
                        w-full
                        rounded
                        py-3
                ...
                <div>
                  ...
                  <span class="absolute top-[-36.75rem] right-[-4.25rem] z-[-1]">
                     <svg
                         width="100"
                         height="100"
                         viewBox="0 0 100 100"
